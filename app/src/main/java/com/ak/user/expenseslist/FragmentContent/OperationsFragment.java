...
import com.ak.user.expenseslist.Adapter.OperationsAdapter;
import com.ak.user.expenseslist.enums.OperationType;
import com.ak.user.expenseslist.objects.AppContext;
...
public class OperationsFragment extends ListFragment
{
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        OperationsAdapter operationsAdapter = new OperationsAdapter(getActivity(), AppContext.getDbAdapter().getOperations(operationType), false);
